...
$consulta = "SELECT * FROM puesto order by desc_puesto asc;";
					...
					<ul>
						...
						<li class="submenu"> <a href="#"><i class="fas fa-user"></i> <span> Empleados </span> <span class="menu-arrow"></span></a>
							<ul class="submenu_class" style="display: none;">
								...
								<li><a class="active" href="add-staff.php">Agregar Empleado</a></li>
							</ul>
						</li> <!--
		...
		<div class="page-wrapper">
			<div class="content container-fluid">
				...
				<div class="row">
					<div class="col-lg-12">
						<form method="post" >
							<h3 class="page-title mt-5">Agregar Empleado</h3>
							<?php
							include "conexion.php";
							include "controlador/agregar_empleado.php";
							?>
							<div class="row formtype">
								<div class="col-md-4">
									<div class="form-group">
										<label>Rut</label>
										<input class="form-control" type="text" placeholder="Ej: 12345678-9" name= "rut_emp"> </div>
								</div>
								<div class="col-md-4">
									<div class="form-group">
										<label>Nombre</label>
										<input class="form-control" type="text" name="nombre_emp"> </div>
								</div>
								<div class="col-md-4">
									<div class="form-group">
										<label>Apellido</label>
										<input class="form-control" type="text" name="apellido_emp" > </div>
								</div>
								<div class="col-md-4">
									<div class="form-group">
										<label>Nacionalidad</label>
										<input class="form-control" type="text" name="nacionalidad" > </div>
								</div>
								<div class="col-md-4">
									<div class="form-group">
										<label>Email</label>
								...
								<div class="col-md-4">
									<div class="form-group">
										...
										<input class="form-control" type="text" name="contrasena"> </div>
								</div>
								<!--
								<div class="col-md-4">
									<div class="form-group">
								...
								<div class="col-md-4">
									<div class="form-group">
										...
										<?php 
										while ($puesto = mysqli_fetch_array($ejecutar,MYSQLI_ASSOC)):;
										?>
										<option value="<?php echo $puesto["id_puesto"];?>">
										<?php echo $puesto["desc_puesto"];
										?>
										</option>
										<?php 
										endwhile;
