		...
		<div class="row">
			<div class="col-lg-12">
				<form method="post">
					<div class="page-header">	
						<div class="row align-items-center">
							<div class="col">
								...
								<?php 
								include "conexion.php";
								include "controlador/modificar_habitacion.php";
								?>
								<?php 
								while($datos=$sql->fetch_object()){?>
									...
									<div class="col-md-4">
											<div class="form-group">
												...
												<input class="form-control" type="text" name="desc_depto" value="<?=$datos->desc_depto ?>"> 
											</div>
										</div>
										<div class="col-md-4">
											<div class="form-group">
												<label>Nombre Habitación</label>
												<input class="form-control" type="text" name="nombre_hab" value="<?=$datos->nombre_hab ?>"> 
											</div>
										</div>
										<div class="col-md-4">
											<div class="form-group">
												<label>Dirección</label>
												<input class="form-control" type="text" name="calle" value="<?=$datos->calle ?>"> 
											</div>
										</div>
										...
										<div class="col-md-4">
											<div class="form-group">
												...
												<select class="form-control" name="id_comuna">
													<option value="<?=$datos->id_comuna?>"><?=$datos->Descrip_comuna?></option>
												<?php 
												while ($dep = mysqli_fetch_array($ejecutar,MYSQLI_ASSOC)):; 
												?>
												<option value="<?php echo $dep["id_comuna"];?>">
												<?php echo $dep["Descrip_comuna"];
												?>
												</option>
												<?php 
												endwhile; 
										...
										<div class="col-md-4">
											<div class="form-group">
												...
												<select class = "form-control" name="televisores">
													<option> <?=$datos->televisores ?> </option>
													<option values="1">1</option>
													<option values="2">2</option>
													<option values="3">3</option>
												</select>	
										...
										<div class="col-md-4">
											<div class="form-group">
												...
												<input type="text" class="form-control" name="valor_habitacion" value="<?=$datos->valor_habitacion?>"> 
											</div>
										</div>
										...
										<div class="col-md-4">
											<div class="form-group">
												...
												<select class="form-control" name="disponibilidad" >
													<option><?=$datos->disponibilidad?></option>
										...
										<div class="col-md-4">
											<div class="form-group">
												...
												<textarea class="form-control" rows="5" name="desc_habitacion" ><?=$datos->desc_habitacion?></textarea>
											</div>
										</div>
					...
					<center>
						<input type="submit" value="Editar"  name = "btneditar" class="btn btn-pill text-white  btn-primary">
					</center>
