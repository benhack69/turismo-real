        ...
        <div class="row">
          <div class="col-md-12">
            <div class="view-options bg-white py-3 px-3 d-md-flex align-items-center">
              <div class="mr-auto">
                <a href="departamentos.php" class="icon-view view-module"><span class="icon-view_module"></span></a>
                <a href="vista_dep.php" class="icon-view view-list active"><span class="icon-view_list"></span></a>
            ...
            <div class="property-entry horizontal d-lg-flex">
              ...
              <div class="p-4 property-body">
               <!-- <a href="#" class="property-favorite"><span class="icon-heart-o"></span></a> -->
                ...
                <p><?= $datos->desc_habitacion?></p>
                <ul class="property-specs-wrap mb-3 mb-lg-0">
                  <li>
                    <span class="property-specs">Piezas</span>
                    <span class="property-specs-number"><?= $datos->piezas?></span>
