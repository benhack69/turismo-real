...
<html lang="en">
              ...
              <div class="col-md-12">
                <div class="form-block">
                  <form action="" method="POST">
                    ...
                    include "controlador/registro/registro_user.php";
                    ?>
                    ...
                    <input type="submit" value="Registrar"  name = "registro" class="btn btn-pill text-white btn-block btn-primary">
  ...
  <script src="js/rutvalidar.js"></script>
